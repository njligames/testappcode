...
macro(GO_SWIG)
  ...
  list(APPEND CMAKE_SWIG_FLAGS "-intgosize;64")
  # list(APPEND CMAKE_SWIG_FLAGS "-gccgo")
  list(APPEND CMAKE_SWIG_FLAGS "-cgo")
  ...
  install(DIRECTORY ${CMAKE_SWIG_OUTDIR} DESTINATION ${CMAKE_INSTALL_PREFIX}/test/${SWIG_WRAP_LANG} FILES_MATCHING PATTERN "*.go")
