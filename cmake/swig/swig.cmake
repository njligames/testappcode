if(DEFINED SWIG_WRAP_LANG)
    ...
    set_property(SOURCE "${SWIG_INCLUDE_DIR}/swig.i" PROPERTY INCLUDE_DIRECTORIES ${SWIG_WRAP_INCLUDE} ${GAME_INCLUDE_DIRS} ${SWIG_INCLUDE_DIR})
    ...
    set_property(SOURCE "${SWIG_INCLUDE_DIR}/swig.i" PROPERTY SWIG_INCLUDE_DIRECTORIES "${SWIG_WRAP_INCLUDE} ${GAME_INCLUDE_DIRS} ${SWIG_INCLUDE_DIR}")
    ...
    install(TARGETS ${${SWIG_WRAP_LANG}_INSTALL_LIBS} EXPORT gameTargets
        ...
        LIBRARY DESTINATION lib/${PROJECT_NAME}/${SWIG_WRAP_LANG}
        ARCHIVE DESTINATION archive/${PROJECT_NAME}/${SWIG_WRAP_LANG}
        RUNTIME DESTINATION bin/${PROJECT_NAME}/${SWIG_WRAP_LANG}
        )
