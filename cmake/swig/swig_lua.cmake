...
if( ANDROID)
    ...
    # set_target_properties(lua PROPERTIES INCLUDE_DIRECTORIES "${THIRDPARTY_INCLUDE_DIR}/includes/lua")

    set_property(TARGET lua PROPERTY PUBLIC_HEADER ${THIRDPARTY_INCLUDE_DIR}/includes/lua)
    set_property(TARGET lua PROPERTY INCLUDE_DIRECTORIES ${THIRDPARTY_INCLUDE_DIR}/includes/lua)
