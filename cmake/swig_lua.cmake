...
macro(LUA_SWIG)
  ...
  if(NOT PROJECT_NAME)
    MESSAGE(FATAL_ERROR "PROJECT_NAME variable is empty.")
  endif()

  set(PROJECT_SWIG_INCLUDE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/swig.in")
  ...
  if(NOT EXISTS "${PROJECT_SWIG_INCLUDE_DIR}/swig.i")
    MESSAGE(FATAL_ERROR "Path doesn't exist: ${PROJECT_SWIG_INCLUDE_DIR}/swig.i")
  endif()

  list(APPEND INCLUDE_DIRS ${PROJECT_SWIG_INCLUDE_DIR})
  ...
  list(APPEND SWIG_SOURCE_FILES
    "${PROJECT_SWIG_INCLUDE_DIR}/swig.i"
  ...
  target_link_libraries(${SWIG_MODULE_${SWIG_TARGET_NAME}_REAL_NAME} ${PROJECT_NAME}-static)
  ...
  if(NOT LINUX AND NOT EMSCRIPTEN AND NOT IOS AND NOT TVOS AND NOT ANDROID)
    ...
    set(SWIG_TARGET_NAME ${PROJECT_NAME}-${SWIG_WRAP_LANG}-swig)
  ...
  if(NOT EMSCRIPTEN AND NOT IOS AND NOT TVOS AND NOT ANDROID AND NOT LINUX)
    ...
    set(SWIG_TARGET_NAME ${PROJECT_NAME})
